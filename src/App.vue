...
function showMap() {
  ...
  store.item = city[15].children
  const data = city.map(v => {
    return {
      name: v.name,
      value: geoCoordMap[v.name].concat(v.total.nowConfirm),
      children: JSON.parse(JSON.stringify(v.children))
    }
...
<template>
  <div class="box" :style="{ background: `url(${bg})`, backgroundSize: 'cover' }">
    ...
    <div class="box-center" id="map" ref="chart"></div>
